...
class Freak(VulnerabilityTest):
    ...
    def test(self, version):
        ...
        rsa_export_cipher_suites = filter_cipher_suite_bytes(cipher_suite_bytes, "RSA.*EXPORT")
        client_hello = ClientHello(version, rsa_export_cipher_suites, False).construct_client_hello()
