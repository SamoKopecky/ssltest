...
class Logjam(VulnerabilityTest):
    ...
    def test(self, version):
        ...
        dh_export_cipher_suites = filter_cipher_suite_bytes(cipher_suite_bytes, "DH.*EXPORT")
        client_hello = ClientHello(version, dh_export_cipher_suites, False).construct_client_hello()
