...
from src.parser import session_info
...
class TestCryptoParams(unittest.TestCase):
    ...
    def test_parse_protocol_version(self):
        ...
        protocol = 'TLSv1.2'
        params = CryptoParams(self.cert, self.cipher_suite, protocol)
    ...
    def test_rate_parameters(self):
        ...
        params.params[CPEnum.CERT_PUB_KEY_ALG_KEY_ALG][0] = 'RSA'
        params.params[CPEnum.CERT_PUB_KEY_ALG_KEY_LEN][0] = '1500'
        ...
        self.assertEqual(params.params[CPEnum.CERT_PUB_KEY_ALG_KEY_LEN][1], 3)
